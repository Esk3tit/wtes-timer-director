...
const EVENTS_COLLECTION = process.env.NEXT_PUBLIC_APPWRITE_EVENTS_COLLECTION_ID;

export { client, account, tables, functions, DATABASE_ID, TIMERS_COLLECTION, QUEUE_COLLECTION, SETTINGS_COLLECTION, EVENTS_COLLECTION };
